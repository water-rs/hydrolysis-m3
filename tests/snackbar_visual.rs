...
#[waterui::test(theme = hydrolysis_m3::Material3::defaults(), viewport = (640, 360))]
fn snackbar_fades_and_slides_into_place(ui: UiBuilder<Styled<hydrolysis_m3::Material3>>) {
